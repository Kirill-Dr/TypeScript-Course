...
function Positive() {
    return (target, propertyKey, parameterIndex) => {
        ...
        let exitsParams = Reflect.getOwnMetadata(POSITIVE_METADATA_KEY, target, propertyKey) || [];
        exitsParams.push(parameterIndex);
        Reflect.defineMetadata(POSITIVE_METADATA_KEY, exitsParams, target, propertyKey);
    };
}
function Validate() {
